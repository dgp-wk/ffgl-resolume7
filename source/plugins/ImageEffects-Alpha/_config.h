...
#define PLUGIN_ID				"IE07"			// Provide a unique 4-character string that identifies this plugin.
#define PLUGIN_NAME				",Opacity"		// This can be any string. This is the name of the plugin as it appears in the Resolume effects list.
...
#define PLUGIN_DESCRIPTION		"Sets Alpha Channel"
#define PLUGIN_ABOUT			"Sets Alpha Channel."
